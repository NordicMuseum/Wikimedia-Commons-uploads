...
class NMInfo(MakeBaseInfo):
    ...
    def load_data(self, harvest_file):
        """
        ...
        :param harvest_file: the path to the metadata file
        :return: dict
        """
        return common.open_and_read_file(harvest_file, as_json=True)
    ...
    def main(cls, *args):
        ...
        usage = (
            'Usage:'
            '\tpython make_info.py -harvest_file:PATH -dir:PATH\n'
            '\t-harvest_file:PATH path to metadata file\n'
            ...
            '\tExample:\n'
            '\tpython make_NordicMuseum_info.py -harvest_file:dimu_harvest_data.json '
